        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="inline-block backdrop-blur-md bg-primary/10 border border-primary/20 rounded-full px-4 py-1.5 text-sm font-medium text-primary animate-fade-in">
              Simplify scheduling on WhatsApp
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight animate-fade-in">
              AI Scheduling <span className="text-gradient-blue">Assistant</span> for Your Business
            </h1>
            
            <p className="text-lg md:text-xl text-muted-foreground max-w-xl animate-fade-in">
              Automate appointments on WhatsApp with our smart AI chatbot. Perfect for barbershops, clinics, and service businesses.
            </p>
            ...
            <p className="text-sm text-muted-foreground animate-fade-in">
              Used by 1,000+ businesses to schedule over 50,000 appointments monthly
            </p>
          </div>
                ...
                <div className="h-full flex flex-col">
                  ...
                  <div className="flex-1 p-4 space-y-4 overflow-y-auto scrollbar-none">
                    <div className="bg-secondary p-3 rounded-lg rounded-tl-none max-w-[80%]">
                      <p className="text-sm">Hello! I'm your scheduling assistant. Would you like to book an appointment?</p>
                    </div>
                    
                    <div className="bg-primary/20 p-3 rounded-lg rounded-tr-none max-w-[80%] ml-auto">
                      <p className="text-sm">Yes, I need a haircut tomorrow afternoon</p>
                    </div>
                    
                    <div className="bg-secondary p-3 rounded-lg rounded-tl-none max-w-[80%]">
                      <p className="text-sm">Great! I have the following slots available tomorrow:</p>
                    ...
                    <div className="bg-secondary p-3 rounded-lg rounded-tl-none max-w-[80%]">
                      <p className="text-sm">Perfect! I've booked you for a haircut tomorrow at 3:30 PM with Alex. You'll receive a reminder 1 hour before.</p>
                    </div>
                  </div>
                </div>
              </div>
