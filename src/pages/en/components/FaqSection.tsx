  ...
  const faqs = [
    {
      ...
      answer:
        "Our AI-powered chatbot integrates directly with WhatsApp. Customers can send messages to your WhatsApp business number, and our AI assistant handles the entire scheduling process - from checking availability to sending confirmations and reminders. All conversations happen naturally, as if they were chatting with a human assistant.",
    },
    {
      question: "Do I need technical knowledge to set it up?",
      answer:
        "Not at all. Our setup process is designed to be extremely user-friendly. We'll guide you through connecting your WhatsApp Business number, importing your service information, and setting your availability preferences. The entire process typically takes less than 10 minutes to complete.",
    },
    {
      question: "Can it integrate with my existing scheduling system?",
      answer:
        "Yes! Our solution integrates with popular scheduling and calendar systems like Google Calendar, Microsoft Outlook, Calendly, Acuity, and more. During setup, you'll be able to connect your existing tools, ensuring all appointments stay synchronized across platforms.",
    },
    {
      question: "What languages does the chatbot support?",
      answer:
        "Currently, our chatbot supports English, Spanish, Portuguese, French, and German. We're continuously adding support for more languages. If you need a specific language that's not currently supported, please contact us to discuss your requirements.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Absolutely! You can customize the chatbot's personality, greeting messages, confirmation texts, and more. For businesses with specific needs, our Custom Bot service allows for even deeper customization of the conversation flow and integration capabilities.",
    },
  ];
